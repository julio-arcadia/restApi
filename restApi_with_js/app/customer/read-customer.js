     ...
     read_customer_html+=`
        <tr>
            ...
            <td>
                ...
                <button class='btn btn-primary m-r-10px read-one-customer-button' data-id='` + val.customerID + `'>
                    <span class='glyphicon glyphicon-eye-open'></span> Read
                </button>
 
                <!-- edit button -->
                <button class='btn btn-info m-r-10px update-customer-button' data-id='` + val.customerID + `'>
                    <span class='glyphicon glyphicon-edit'></span> Edit
                </button>
 
                <!-- delete button -->
                <button class='btn btn-danger delete-customer-button' data-id='` + val.customerID + `'>
